...
class PerfilConsumidor extends StatefulWidget {
  final int consumidorId;

  const PerfilConsumidor({Key? key, required this.consumidorId}) : super(key: key);

  @override
  _PerfilConsumidorState createState() => _PerfilConsumidorState();
}

class _PerfilConsumidorState extends State<PerfilConsumidor> {
  ...
  Future<void> _carregarDadosUsuario() async {
    ...
    final usuario = await dbHelper.buscarUsuarioPorId(widget.consumidorId);
    setState(() {
      _usuario = usuario;
    });
  }
